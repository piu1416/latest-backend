        ...
        public IActionResult Login([FromBody]LoginModel login)
        {
            ...
            else
            {
                ...
                if (customer != null)
                {
                    ...
                    model = new LoggedUserModel() { Id = customer.CustomerId, EmailID = customer.CustomerEmail, Token = token, Role = customer.Role, Message = "Welcome to EBills! You have been Successfully Logged In." };
                    return Ok(model);
                }
                else
                {
